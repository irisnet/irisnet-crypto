...
const MsgSend = Root.irisnet.MsgSend;
MsgSend.prototype.GetSignBytes = function () {

    let msg = {
        "from_address": BECH32.encode(Config.iris.bech32.accAddr,this.FromAddress),
        "to_address": BECH32.encode(Config.iris.bech32.accAddr,this.ToAddress),
        "amount": this.Amount
    };
...
MsgSend.prototype.type = Config.iris.tx.transfer.prefix;
MsgSend.prototype.GetDisplayContent = function (){
    let from = BECH32.encode(Config.iris.bech32.accAddr,this.FromAddress);
    let to = BECH32.encode(Config.iris.bech32.accAddr,this.ToAddress);
    return {
